...
_STRINGS = {
    "en": {
        ...
        "drag_account_hint": "Drag to change this account’s position in the sidebar",
        ...
        "rename_account": "Rename account", "rename_account_hint": "This changes only the name shown in TuxInDrive. The provider login, credentials and synchronized folders stay unchanged.",
        "account_name_required": "The displayed account name cannot be empty.",
    ...
    "de": {
        ...
        "drag_account_hint": "Ziehen, um die Position dieses Kontos in der Seitenleiste zu ändern",
        ...
        "rename_account": "Konto umbenennen", "rename_account_hint": "Dies ändert nur den in TuxInDrive angezeigten Namen. Anmeldung, Zugangsdaten und synchronisierte Ordner bleiben unverändert.",
        "account_name_required": "Der angezeigte Kontoname darf nicht leer sein.",
    ...
    "fr": {
        ...
        "drag_account_hint": "Faire glisser pour modifier la position de ce compte dans la barre latérale",
        ...
        "rename_account": "Renommer le compte", "rename_account_hint": "Seul le nom affiché dans TuxInDrive est modifié. La connexion, les identifiants et les dossiers synchronisés restent inchangés.",
        "account_name_required": "Le nom de compte affiché ne peut pas être vide.",
    ...
    "es": {
        ...
        "drag_account_hint": "Arrastre para cambiar la posición de esta cuenta en la barra lateral",
        ...
        "rename_account": "Cambiar nombre de cuenta", "rename_account_hint": "Solo cambia el nombre mostrado en TuxInDrive. El inicio de sesión, las credenciales y las carpetas sincronizadas no cambian.",
        "account_name_required": "El nombre de cuenta mostrado no puede estar vacío.",
    ...
    "ar": {
        ...
        "drag_account_hint": "اسحب لتغيير موضع هذا الحساب في الشريط الجانبي",
        ...
        "rename_account": "إعادة تسمية الحساب", "rename_account_hint": "يغيّر هذا الاسم المعروض في TuxInDrive فقط. يبقى تسجيل الدخول وبيانات الاعتماد والمجلدات المتزامنة دون تغيير.",
        "account_name_required": "لا يمكن أن يكون اسم الحساب المعروض فارغًا.",
    ...
    "he": {
        ...
        "drag_account_hint": "גררו כדי לשנות את מיקום החשבון בסרגל הצד",
        ...
        "rename_account": "שינוי שם החשבון", "rename_account_hint": "פעולה זו משנה רק את השם המוצג ב-TuxInDrive. פרטי הכניסה, האישורים והתיקיות המסונכרנות אינם משתנים.",
        "account_name_required": "שם החשבון המוצג אינו יכול להיות ריק.",
