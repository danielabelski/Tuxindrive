...
Version 0.26.44 adds persistent account renaming and drag-and-drop sidebar ordering to readable multi-line account identities across supported providers and truthful Google Drive root identity with the competitive P0/P1 reliability work and a
...
The following controls are enforced in 0.26.44:
