...
Version 0.26.45 adds verified two-way completion and safe endpoint-change pausing to persistent account renaming, drag-and-drop sidebar ordering, readable multi-line account identities across supported providers and truthful Google Drive root identity with the competitive P0/P1 reliability work and a
...
The following controls are enforced in 0.26.45:
