...
Version 0.26.47 fixes complete Midnight Sync dark rendering across GTK cards, lists, viewports and dialogs, extends duplicate-provider detection to both source and destination listings, and retains non-destructive automatic cloud-duplicate renaming, verified two-way completion, safe endpoint-change pausing, persistent account renaming, drag-and-drop sidebar ordering, readable multi-line account identities across supported providers and truthful Google Drive root identity with the competitive P0/P1 reliability work and a
...
The following controls are enforced in 0.26.47:
