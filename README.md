...
Version 0.26.46 adds non-destructive automatic cloud-duplicate renaming and a controlled follow-up resync to verified two-way completion and safe endpoint-change pausing, persistent account renaming, drag-and-drop sidebar ordering, readable multi-line account identities across supported providers and truthful Google Drive root identity with the competitive P0/P1 reliability work and a
...
The following controls are enforced in 0.26.46:
