...
The 0.26.38 cross-folder filename index remains entirely on each desktop
...
Download `tuxindrive-server_0.26.38_all.deb` from the matching
[GitHub Release](https://github.com/tpluharik/Tuxindrive/releases/tag/v0.26.38),
...
installing 0.26.38 replaces its launcher and completes the pending package
...
sudo apt install ./dist/tuxindrive-server_0.26.38_all.deb
```
